...
** Quickstart Guide: Creating your first course with Org-Coursepack 
:PROPERTIES:
...
*** Installation
Follow instructions on [[https://github.com/joonro/Org-Coursepack#installation][README]] to install =Org-Coursepack= along with its
dependencies.
...
the materials for. See example below (we changed the names to =Example
Course=):

#+ATTR_LATEX: :width 8cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Course-renamed.png
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Semester-renamed.png
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Semester-Org-File.png

You can freely move the cursor around using the arrow keys. Many items such as
such as [[https://orgmode.org/manual/Drawers.html][drawers]] (e.g., =:LOCALSETUP:=) and [[https://orgmode.org/manual/Headlines.html][subtrees]] (e.g., ~* Sections~) are
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Org-Expand.png
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Semester-Rename-Semester-Before.png
...
As shown below, all occurrences of =Semester Template.org= are replaced by =2020
Spring.org=:

#+ATTR_LATEX: :height 3cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Semester-Rename-Semester-After.png
...
#+ATTR_LATEX: :height 3cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Semester-Rename-Course-Before.png
...
#+ATTR_LATEX: :height 3cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Semester-Rename-Course-After.png
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Semester-Course-Info.png

You can fill the macro values with your own course information as shown in the
image below.

#+ATTR_LATEX: :height 4cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Semester-Course-Info-Edited.png
...
[[https://joonro.github.io/Org-Coursepack/Lectures/07%2520Semester%2520Org%2520Files%25202%25204%2520Sections%2520and%2520Syllabus.html#syllabus-top-level-tree][2 Syllabus Top-level Tree]] of the documentation contains detailed information about 
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Syllabus-Schedule-Old.png
...
#+ATTR_LATEX: :width 16cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Syllabus-Schedule-New.png
...
#+ATTR_LATEX: :width 10cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Section-Information-Properties.png

To export the syllabus in our example, navigate to the =*
Sections/01/Syllabus= headline, then expand its =:PROPERTIES:= drawer. When
...
#+ATTR_LATEX: :width 10cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Syllabus-Export-Link.png

See the screenshots of the exported syllabus (the first and the class schedule pages) below.

#+ATTR_LATEX: :width 10cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Syllabus-Exported-Course-Desc.png

#+ATTR_LATEX: :width 10cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Syllabus-Exported-Schedule.png
...
#+ATTR_LATEX: :width 10cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Export-Link.png

The following image shows an example of an exported html =reveal.js= slides
(the slide overview mode). 

#+ATTR_LATEX: :height 9cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Exported_reveal.js.png

The image below shows an example of an exported PDF handout.

#+ATTR_LATEX: :height 8cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Exported_LaTeX.png
...
See [[https://joonro.github.io/Org-Coursepack/Lectures/05%2520Exporting%2520Slides%2520and%2520Handouts.html][Exporting Slides and Handouts]] for more information about exporting lectures.

**** Adding new classes/lectures and updating their metadata
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Lectures-Lectures.png
...
subtrees. In the example, we will simply call them =Second Lecture= and =Third
Lecture=:

#+ATTR_LATEX: :height 8cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lectures-Second-Lecture.png
...
#+ATTR_LATEX: :height 3cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lectures-Run-Script-Update-Lectures.png

Press =y= to confirm when asked (see image below).

#+ATTR_LATEX: :width 11cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lectures-Run-Script-Update-Lectures-Confirm.png
...
#+ATTR_LATEX: :height 4cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lectures-Updated-Lecture-Info.png 
...
#+ATTR_LATEX: :height 4cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lectures-Updated-Boilerplate.png 
...
#+ATTR_LATEX: :height 4cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Syllabus-Schedule-Updated.png
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Include.png
...
into a semester Org file. See the [[https://joonro.github.io/Org-Coursepack/Lectures/08%2520Semester%2520Org%2520Files%25203%25204%2520Lectures.html][Lectures]] part of the documentation for more
details.
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_New_Section.png
...
more detailed instructions, see the [[https://joonro.github.io/Org-Coursepack/Lectures/04%2520Creating%2520Content%2520for%2520Slides%2520and%2520Handouts.html][Creating Content for Slides and Handouts]]
section of the documentation. You can also see [[https://orgmode.org/manual/index.html][Org manual]].

*Lists.* Org mode uses a typical syntax (=-= or =+= for lists, =1.= for
numbered lists) for lists. For example,

#+ATTR_LATEX: :height 4cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Lists.png

*Math.* you can directly input LaTeX math in Org mode. For example,

#+ATTR_LATEX: :height 1.8cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Math.png

In =reveal.js= slides, math will be rendered with [[https://www.mathjax.org][MathJax]].

*Code.* Code can be inputting using [[https://orgmode.org/manual/Structure-of-code-blocks.html][code blocks]], which can be easily inserted
by pressing ~<s~ and then ~<TAB>~ key in Org mode. For example,

#+ATTR_LATEX: :height 1.8cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Code.png
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Exported_Code-reveal.js.png

file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Exported_Code-LaTeX.png
...
#+ATTR_LATEX: :height 1.8cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Split.png

*Fragmented contents.* Fragmented contents (e.g., items in a listing being
presented one after another) can be specified by putting =#+ATTR_REVEAL: :frag
(appear)= before the contents that are to be fragmented. For example:

#+ATTR_LATEX: :height 1.8cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Fragmented.png
...
To adjust the size of the image, specify HTML attributes (e.g., =#+ATTR_HTML:
:width 80%=) or LaTeX attributes (e.g., =#+ATTR_LATEX: :width 6cm=) before the
image file path.

For example,

#+ATTR_LATEX: :height 2.5cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Images.png
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Hiding-Contents.png
...
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Hiding-Contents-reveal.js.png

#+ATTR_LATEX: :width 7.5cm
file:../../../Assets/Images/Org-Teaching/Quickstart/Lecture-Editing_Hiding-Contents-LaTeX.png
#+LATEX: \end{multicols}
*** Conclusion
...
Please let us know through [[https://github.com/joonro/Org-Coursepack/issues][GitHub issues]] if you have any questions or
issues.
...
#+BEGIN_COMMENT
- This, combined with a Emacs-lisp script
  (=org-coursepack-update-lecture-metadata=), which can be called in
  =Lectures= subtree, which automatically updates individual class metadata,
  ...
  class on Lectures for more information about =Update lecture metadata=
  script.
#+END_COMMENT
...
**** =org-coursepack-update-lecture-metadata= Source Code Block
- The =Lectures= top-level tree has a call statement (~#+CALL:
  org-coursepack-update-lecture-metadata()~) that can be used to execute the
  ...
  1. Update metadata for the lecture, such as the class number (=:CLASS:=),
     ...
     - =:CLASS:= :: The lectures are assumed to be in the order of the lecture
                    ...
                    dates and holidays).
     - =:DATE:= :: It will get the date of each class from the =DATE_CLASS_XX=
                   file-level properties, which are defined in the =Lectures
                   and Assignments Dates= subtree.
  ...
  2. Update =Lecture Outline= under the =Introduction and Recap of Last Class= subtree.
     ...
     - =Lecture Outline= :: The script will get the list of subtrees that
  ...
  3. Update =Last Class= under the =Introduction and Recap of Last Class=
     ...
     - =Recap of Last Class= :: The script will insert an =#+INCLUDE:=
     ...
     - =Class Recap= :: The script will insert an =#+INCLUDE:= statement which
                        points to the current lecture's =Lecture Outline=
                        subtree under the =Introduction and Recap of Last
                        Class=. This provides a summary of the current
                        lecture.
...
#+ATTR_LATEX: :width 8cm
[[file:../../../Assets/Images/Org-Teaching/Semester-Lectures-Dynamic-Columnview.png]]
...
- As described earlier, =:CLASS:= (class number), =:EXPORT_FILE_NAME:=, and
  =:DATE:= (class date) will be automatically updated by the =Update lecture
...
be used to create multiple choice questions. See the Org mode [[https://orgmode.org/manual/Plain-lists.html][manual]] for more
