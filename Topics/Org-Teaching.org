...
the course; the =COURSE= macro is to specify the name of the course, =COURSE_NUM= is to specify the course ID, and so on. They currently have filler values as shown below.

#+ATTR_LATEX: :height 6cm
file:../../../Assets/Images/Org-Teaching/Quickstart_Semester-Course-Info.png

You can fill the macro values with your own course information:
