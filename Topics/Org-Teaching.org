...
*** TODO Requirements
:LOGBOOK:
- State "TODO"       from              [2018-11-19 Mon 20:20] \\
  Make it sound more approachable for any users.
:END:
- Org-Coursepack is a tool based on [[https://orgmode.org/manual/Export-settings.html][Org mode]], a major mode in [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Specifying-File-Variables.html#Specifying-File-Variables][GNU Emacs]]. It
  ...
  knowledge needed is:
  - Emacs :: Basic knowledge of text editing using Emacs
  - Org mode :: Basic knowledge of Org mode markup syntax. Org mode uses a
...
** Quickstart Guide: Create your first class with Org-Coursepack 
:PROPERTIES:
:CUSTOM_ID: Lectures/Quickstart Guide
:END:
:LOGBOOK:
- State "TODO"       from              [2018-11-20 Tue 14:25] \\
  Need this!
:END:
...
*** Copy and rename =Template= course
...
*** Set local variables permission in semester Org file
