...
The example below shows that the semester is Spring 2020. You can rename the =Semester= folder and the =Semestor.org= inside that folder to reflect the semester in which you are teaching that course. 
