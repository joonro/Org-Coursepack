...
#+BEGIN_COMMENT
- This, combined with a Emacs-lisp script (=Update lecture metadata=) contained in
  ...
  class on Lectures for more information about =Update lecture metadata= script.
...
**** =Update lecture metadata= Source Code Block
