...
*** Set local variable permissions in the semester Org file
Visit (i.e., open) =2020 Spring.org=. First time you visit this file, it will 
...
*** Rename paths to semester and course Org files for =#+INCLUDE= statements
...
of the current semester Org file, =./2020 Spring.org::=. This can be achieved in
Emacs by pressing =M-%= (=Alt+Shift+5=, or via =Edit= -> =Replace= -> =Replace
String= menu), and inputting =./Semester.org::<Enter>= followed by =./2018
Fall.org::<Enter>=, and pressing =!= (replace all). Emacs will let you know
...
So all =./Semester.org::= are replaced by =./2020 Spring.org::=:
...
The first several lines of the semester Org file (=2020 Spring.org=) contain
...
**** Editing syllabus content
While the syllabus will be exported from this semester Org file (=2018
...
Let's modify the course description. Navigate to =* Syllabus/Course
Description=. When you expand =Course Description= subtree (see the screenshot
...
#+ATTR_LATEX: :height 3cm
file:../../../Assets/Images/Org-Teaching/Quickstart_Syllabus-Course-Description.png
...
#+ATTR_LATEX: :height 3cm
file:../../../Assets/Images/Org-Teaching/Quickstart_Syllabus-Course-Description-Content-Edited.png

Now if you again click on the LaTeX export button in the =:PROPERTIES:= of the =Syllabus= 
tree in the semester Org file (=2020 Spring.org=), you will see that the new course description 
is reflected in the exported pdf.

#+ATTR_LATEX: :height 6cm
file:../../../Assets/Images/Org-Teaching/Quickstart_Syllabus-Exported-Course-Desc.png
