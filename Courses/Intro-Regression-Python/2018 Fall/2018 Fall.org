...
:OUTPUT_VIEW: [[elisp:(org-open-link-from-string%20(concat%20"file:./"%20(org-entry-get%20nil%20"EXPORT_FILE_NAME")%20".html"))][HTML]] | [[elisp:(org-open-link-from-string%20(concat%20"file:./"%20(org-entry-get%20nil%20"EXPORT_FILE_NAME")%20".pdf"))][PDF]]
:END:
...
**** Lecture Agenda
:PROPERTIES:
:CUSTOM_ID: Lecture/Introduction to Python Devel Environments and Language Basics/Agenda
:END:
...
#+INCLUDE: "./2018 Fall.org::#Lecture/Introduction to Python Devel Environments and Language Basics/Agenda" :only-contents t
